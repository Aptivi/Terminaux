...
{
    internal class TestInputInfoBoxMultiSelection : IFixture
    {
        public void RunFixture()
        {
            ...
            var selections = InfoBoxSelectionMultipleColor.WriteInfoBoxSelectionMultiple(nameof(TestInputInfoBoxMultiSelection), choices, "Which Ubuntu version would you like to run?");
