...
namespace Terminaux.ConsoleDemo.Fixtures.Cases.Input
{
    ...
    {
        public string FixtureID => "TestInputChoiceDisabled";
        public void RunFixture()
        {
            ...
            [
                new("e", "19.10 (Eoan Ermine)", "Ubuntu 19.10 Eoan Ermine is an interim release, released 17 October 2019.", false, false, true),
