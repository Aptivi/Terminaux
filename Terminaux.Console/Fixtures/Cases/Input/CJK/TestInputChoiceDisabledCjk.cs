...
{
    internal class TestInputChoiceDisabledCjk : IFixture
    {
        public string FixtureID => "TestInputChoiceDisabledCjk";
        public void RunFixture()
        {
            ...
            [
                new("e", "19.10 (Eoan Ermine)", "Ubuntu 19.10 Eoan Ermine 是一个临时版本，于 2019 年 10 月 17 日发布。", false, false, true),
