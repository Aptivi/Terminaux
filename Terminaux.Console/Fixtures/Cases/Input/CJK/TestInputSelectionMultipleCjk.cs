...
{
    internal class TestInputSelectionMultipleCjk : IFixture
    {
        public string FixtureID => "TestInputSelectionMultipleCjk";
        public void RunFixture()
        {
            ...
            [
                ...
                new("jammy", "22.04 (Jammy Jellyfish)", "Ubuntu 22.04，代号 Jammy Jellyfish，于 2022 年 4 月 21 日发布，是一个长期支持版本，支持五年，直到 2027 年 4 月。", false, true),
                new("noble", "24.04 (Noble Numbat)", "Ubuntu 24.04，代号Noble Numbat，计划于2024年4月发布，属于长期支持版本，支持五年，直到2029年4月。", true, true),
            ];
