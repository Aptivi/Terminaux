    ...
    public static class InfoBoxTitledSelectionMultipleColor
    {
        ...
        public static int[] WriteInfoBoxTitledSelectionMultipleColor(string title, InputChoiceInfo[] selections, string text, ConsoleColors InfoBoxTitledSelectionMultipleColor, params object[] vars) =>
            WriteInfoBoxTitledSelectionMultipleColorBack(title, selections, text,
                        ...
                        BorderTools.BorderUpperFrameChar, BorderTools.BorderLowerFrameChar,
                        BorderTools.BorderLeftFrameChar, BorderTools.BorderRightFrameChar,
                        new Color(InfoBoxTitledSelectionMultipleColor), ColorTools.currentBackgroundColor, vars);
        ...
        public static int[] WriteInfoBoxTitledSelectionMultipleColor(string title, InputChoiceInfo[] selections, string text,
            ...
            WriteInfoBoxTitledSelectionMultipleColorBack(title, selections, text, UpperLeftCornerChar, LowerLeftCornerChar, UpperRightCornerChar, LowerRightCornerChar, UpperFrameChar, LowerFrameChar, LeftFrameChar, RightFrameChar, new Color(InfoBoxTitledSelectionMultipleColor), ColorTools.currentBackgroundColor, vars);
