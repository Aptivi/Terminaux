...
namespace Terminaux.Inputs.Styles.InfoboxTitled
{
    ...
    public static class InfoBoxTitledSelectionMultipleColor
    {
        ...
        public static int[] WriteInfoBoxTitledSelectionMultipleColorBack(string title, InputChoiceInfo[] selections, string text,
            ...
            WriteInfoBoxTitledSelectionMultipleColorBack(
                                       ...
                                       Color InfoBoxTitledSelectionMultipleColor, Color BackgroundColor, params object[] vars)
        {
            ...
            try
            {
                ...
                while (!bail)
                {
                    ...
                    int left = maxWidth - 3;
                    input.Append(
                        ProgressBarVerticalColor.RenderVerticalProgress(100 * ((double)(currentSelection + 1) / selections.Length), left - 1, selectionBoxPosY - 1, ConsoleWrapper.WindowHeight - selectionChoices, 0, InfoBoxTitledSelectionMultipleColor, BackgroundColor, false)
                    );
