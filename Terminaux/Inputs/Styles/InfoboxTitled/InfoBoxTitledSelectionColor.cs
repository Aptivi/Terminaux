...
namespace Terminaux.Inputs.Styles.InfoboxTitled
{
    ...
    public static class InfoBoxTitledSelectionColor
    {
        ...
        public static int WriteInfoBoxTitledSelectionColor(string title, InputChoiceInfo[] selections, string text,
            ...
            WriteInfoBoxTitledSelectionColorBack(title, selections, text, UpperLeftCornerChar, LowerLeftCornerChar, UpperRightCornerChar, LowerRightCornerChar, UpperFrameChar, LowerFrameChar, LeftFrameChar, RightFrameChar, new Color(InfoBoxTitledSelectionColor), ColorTools.currentBackgroundColor, vars);
        ...
        public static int WriteInfoBoxTitledSelectionColorBack(string title, InputChoiceInfo[] selections, string text,
            ...
            WriteInfoBoxTitledSelectionColorBack(
