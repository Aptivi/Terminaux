...
namespace Terminaux.Inputs.Styles.Infobox
{
    ...
    public static class InfoBoxNonModalColor
    {
        ...
        public static void WriteInfoBox(string text, params object[] vars) =>
            WriteInfoBoxColorBack(text, BorderSettings.GlobalSettings, new Color(ConsoleColors.Silver), ColorTools.currentBackgroundColor, vars);
        ...
        public static void WriteInfoBoxColorBack(string text, BorderSettings settings, Color InfoBoxColor, Color BackgroundColor, params object[] vars) =>
            WriteInfoBoxColorBack("", text, settings, InfoBoxColor, BackgroundColor, true, vars);
        ...
        public static void WriteInfoBoxPlain(string title, string text, BorderSettings settings, params object[] vars) =>
            WriteInfoBoxColorBack(title, text, settings, ColorTools.currentForegroundColor, ColorTools.currentBackgroundColor, false, vars);
        ...
        public static void WriteInfoBoxColorBack(string title, string text, BorderSettings settings, Color InfoBoxTitledColor, Color BackgroundColor, params object[] vars) =>
            WriteInfoBoxColorBack(title, text, settings, InfoBoxTitledColor, BackgroundColor, true, vars);
        ...
        /// <param name="vars">Variables to format the message before it's written.</param>
        internal static void WriteInfoBoxColorBack(string title, string text, BorderSettings settings, Color InfoBoxTitledColor, Color BackgroundColor, bool useColor, params object[] vars)
        {
            ...
            try
            {
                ...
                {
                    return RenderText(0, title, text, settings, InfoBoxTitledColor, BackgroundColor, useColor, ref increment, currIdx, true, false, vars);
                });
