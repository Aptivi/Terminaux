...
namespace Terminaux.Reader.Inputs.Interactive
{
    internal static class InteractiveTuiStatus
    {
        ...
        /// </summary>
        public static Color BackgroundColor { get; set; } = "4";
        /// <summary>
        ...
        /// </summary>
        public static Color PaneBackgroundColor { get; set; } = "12";
        /// <summary>
        ...
        /// </summary>
        public static Color PaneSelectedItemForeColor { get; set; } = "11";
        /// <summary>
        /// Interactive TUI pane selected item color (background)
        /// </summary>
        public static Color PaneSelectedItemBackColor { get; set; } = "4";
        /// <summary>
        ...
        /// </summary>
        public static Color PaneItemBackColor { get; set; } = "12";
        /// <summary>
        /// Interactive TUI option background color
        /// </summary>
        public static Color OptionBackgroundColor { get; set; } = "6";
        /// <summary>
        /// Interactive TUI key binding in option color
        /// </summary>
        public static Color KeyBindingOptionColor { get; set; } = "15";
        /// <summary>
        /// Interactive TUI option foreground color
        /// </summary>
        public static Color OptionForegroundColor { get; set; } = "14";
        /// <summary>
