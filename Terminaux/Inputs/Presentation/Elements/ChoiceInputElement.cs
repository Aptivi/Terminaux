...
namespace Terminaux.Inputs.Presentation.Elements
{
    ...
    public class ChoiceInputElement : IElement
    {
        ...
        public bool IsPossibleOutOfBounds()
        {
            ...
            // Check the bounds
            string[] splitText = ConsoleMisc.GetWrappedSentencesByWords(text, presentationLowerInnerBorderTop - presentationUpperInnerBorderLeft);
            int maxHeight = presentationLowerInnerBorderTop - ConsoleWrapper.CursorTop + 2;
