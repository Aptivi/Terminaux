...
{
    internal class Protan : BaseTransformationFormula, ITransformationFormula
    {
        public override (int, int, int) Transform(int r, int g, int b, ColorSettings settings)
        {
            ...
            var transformed = Brettel.Transform(r, g, b, TransformationFormula.Protan, settings.ColorBlindnessSeverity);
            return transformed;
        }
    }
}
