...
namespace Terminaux.Writer.CyclicWriters
{
    ...
    /// </summary>
    public class PieChart : IStaticRenderable
    {
        ...
        internal static string RenderPieChart(ChartElement[] elements, int InteriorWidth, int InteriorHeight, bool showcase = false, bool useColor = true)
        {
