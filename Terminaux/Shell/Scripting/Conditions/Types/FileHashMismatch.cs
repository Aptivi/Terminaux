...
namespace Terminaux.Shell.Scripting.Conditions.Types
{
    ...
    /// </summary>
    public class FileHashMismatchCondition : BaseCondition, ICondition
    {

        /// <inheritdoc/>
        public override string ConditionName => "finsane";
        ...
        /// <inheritdoc/>
        public override bool IsConditionSatisfied(string FirstVariable, string SecondVariable) => UESHOperators.UESHVariableFileHashNoMatch(FirstVariable, SecondVariable);
