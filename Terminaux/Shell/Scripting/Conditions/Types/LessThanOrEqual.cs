...
namespace Terminaux.Shell.Scripting.Conditions.Types
{
    ...
    public class LessThanOrEqualCondition : BaseCondition, ICondition
    {
        ...
        /// <inheritdoc/>
        public override string ConditionName => "lesoreq";
        ...
        /// <inheritdoc/>
        public override bool IsConditionSatisfied(string FirstVariable, string SecondVariable) => UESHOperators.UESHVariableLessThanOrEqual(FirstVariable, SecondVariable);
