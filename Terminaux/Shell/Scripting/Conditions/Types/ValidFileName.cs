...
{
    /// <summary>
    /// Condition to check if the filename is valid
    /// </summary>
    public class ValidFileNameCondition : BaseCondition, ICondition
    {
        ...
        /// <inheritdoc/>
        public override bool IsConditionSatisfied(string FirstVariable, string SecondVariable) => UESHOperators.UESHVariableValidFileName(FirstVariable);
