...
namespace Terminaux.Shell.Scripting.Conditions.Types
{
    ...
    /// </summary>
    public class NotEqualsCondition : BaseCondition, ICondition
    {

        /// <inheritdoc/>
        public override string ConditionName => "neq";
        ...
        /// <inheritdoc/>
        public override bool IsConditionSatisfied(string FirstVariable, string SecondVariable) => UESHOperators.UESHVariableNotEqual(FirstVariable, SecondVariable);
