...
namespace Terminaux.Shell.Scripting.Conditions.Types
{
    ...
    public class EqualsCondition : BaseCondition, ICondition
    {
        ...
        /// <inheritdoc/>
        public override string ConditionName => "eq";
        ...
        /// <inheritdoc/>
        public override bool IsConditionSatisfied(string FirstVariable, string SecondVariable) => UESHOperators.UESHVariableEqual(FirstVariable, SecondVariable);
