...
namespace Terminaux.Shell.Scripting.Conditions.Types
{
    ...
    public class FileHashMatchCondition : BaseCondition, ICondition
    {
        ...
        /// <inheritdoc/>
        public override bool IsConditionSatisfied(string FirstVariable, string SecondVariable) => UESHOperators.UESHVariableFileHashMatch(FirstVariable, SecondVariable);
