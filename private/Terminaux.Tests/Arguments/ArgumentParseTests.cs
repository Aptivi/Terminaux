...
namespace Terminaux.Tests.Arguments
{
    ...
    {
        private readonly static Dictionary<string, ArgumentInfo> testArgs = new()
        {
            { "lang",
                new ArgumentInfo("lang", "Changes the language",
                    [
        ...
        {
            // Create instance
            var argArginfo = ArgumentsParser.ParseArgumentArguments("lang", testArgs).total[0];
        ...
        {
            // Create instance
            var argArginfo = ArgumentsParser.ParseArgumentArguments("lang eng", testArgs).total[0];
        ...
        {
            // Create instance
            var argArginfo = ArgumentsParser.ParseArgumentArguments("lang -switch", testArgs).total[0];
        ...
        {
            // Create instance
            var argArginfo = ArgumentsParser.ParseArgumentArguments("lang -switch eng", testArgs).total[0];
