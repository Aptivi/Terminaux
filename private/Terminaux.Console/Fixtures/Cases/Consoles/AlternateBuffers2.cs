...
{
    internal class AlternateBuffers2 : IFixture
    {
        ...
        public void RunFixture()
        {
            ...
            Input.ReadKey();
            ConsoleMisc.ShowMainBuffer();
            TextWriterRaw.WritePlain("A short showcase for the two buffers will be shown. Here, we're at the main buffer.");
            Input.ReadKey();
            ConsoleMisc.PreviewAltBuffer();
