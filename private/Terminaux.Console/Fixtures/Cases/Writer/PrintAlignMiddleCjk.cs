...
namespace Terminaux.Console.Fixtures.Cases.Writer
{
    internal class PrintAlignMiddleCjk : IFixture
    {
        ...
        public void RunFixture()
        {
            ...
            {
                Text = $"你好，世界！它位于{ConsoleColoring.RenderSetConsoleColor(new Color(ConsoleColors.Blue))}控制台的中心{ConsoleColoring.RenderSetConsoleColor(new Color(ConsoleColors.Green))}。",
