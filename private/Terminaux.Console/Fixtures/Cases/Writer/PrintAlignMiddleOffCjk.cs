...
namespace Terminaux.Console.Fixtures.Cases.Writer
{
    internal class PrintAlignMiddleOffCjk : IFixture
    {
        ...
        public void RunFixture()
        {
            ...
            {
                Text = $"你好，世界！它位于{ConsoleColoring.RenderSetConsoleColor(new Color(ConsoleColors.Blue))}控制台的中心{ConsoleColoring.RenderSetConsoleColor(new Color(ConsoleColors.Green))}，并且故意设计得很长，以演示右边距偏移和左边距偏移的偏心效果。",
