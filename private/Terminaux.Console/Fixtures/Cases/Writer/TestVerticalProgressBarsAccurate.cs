...
{
    internal class TestVerticalProgressBarsAccurate : IFixture
    {
        ...
        public void RunFixture()
        {
            ...
            var progressBar2 = new SimpleProgress(0, 100)
            {
                Height = 20,
                Indeterminate = true,
                Vertical = true,
            ...
            container.SetRenderablePosition("Progress bar 2", new(6, 2));
