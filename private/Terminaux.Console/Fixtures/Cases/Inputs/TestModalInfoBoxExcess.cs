...
{
    internal class TestModalInfoBoxExcess : IFixture
    {
        ...
        public void RunFixture()
        {
            ...
            InfoBoxModalColor.WriteInfoBoxModal(
                "This info box full of information below should close when you press ENTER after the last line:\n\n" +
                ...
                , new InfoBoxSettings()
                {
                    Title = "Excess modal information box"
                }
            );
