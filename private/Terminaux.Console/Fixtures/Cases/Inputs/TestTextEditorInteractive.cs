...
{
    internal class TestTextEditorInteractive : IFixture
    {
        ...
        public void RunFixture()
        {
            string toBeEdited =
                $"""
                Lorem ipsum dol{ConsoleColoring.RenderResetForeground()}or sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
            ...
            TextEditInteractive.OpenInteractive(ref editLines);
            string final = string.Join("\n", editLines);
            TextWriterColor.Write(final);
        }
    }
}
