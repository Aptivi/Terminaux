...
{
    internal class TestHexEditorFullscreenInteractiveCjk : IFixture
    {
        ...
        public void RunFixture()
        {
            ...
            HexEditInteractive.OpenInteractive(ref editBytes, fullscreen: true);
            string final = Encoding.Default.GetString(editBytes);
