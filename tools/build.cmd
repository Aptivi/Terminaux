...
"%ProgramFiles%\dotnet\dotnet.exe" restore "%ROOTDIR%\Terminaux.sln" -p:Configuration=%releaseconfig% %buildoptions%
...
:build
echo Building...
"%ProgramFiles%\dotnet\dotnet.exe" build "%ROOTDIR%\Terminaux.sln" -p:Configuration=%releaseconfig% %buildoptions%
