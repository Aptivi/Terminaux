...
namespace Terminaux.Images.Icons
{
    ...
    {
        private static readonly ResourceManager resourceManager = new("Terminaux.Images.Icons.Resources.Languages.Output.Localizations", typeof(LanguageTools).Assembly);
