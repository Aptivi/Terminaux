...
namespace Terminaux.Shell.Shells
{
    ...
    public static class ShellManager
    {
        ...
        [
            new CommandInfo("exit", LanguageTools.GetLocalized("T_SHELL_UNIFIED_EXIT_HELP_DESC"), new ExitUnifiedCommand()),
            ...
            new CommandInfo("presets", LanguageTools.GetLocalized("T_SHELL_UNIFIED_PRESETS_HELP_DESC"), new PresetsUnifiedCommand()),
        ];
