...
namespace Terminaux.Shell.Shells.Unified
{
    ...
    class TruncateCommand : BaseCommand, ICommand
    {
        ...
        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_TRUNCATE_DESC");
        ...
        public override CommandArgumentInfo[] CommandArgumentInfo =>
            [
                ...
                [
                    ...
                    {
                        ArgumentDescription = LanguageTools.GetLocalized("T_SHELL_UNIFIED_TRUNCATE_ARGUMENT_THRESHOLD_DESC"),
                        IsNumeric = true,
                    }),
                ],
                [
                    new SwitchInfo("noellipsis", LanguageTools.GetLocalized("T_SHELL_UNIFIED_TRUNCATE_SWITCH_NOELLIPSIS_DESC"), new SwitchOptions()
                    {
                        AcceptsValues = false
                    }),
