...
{
    /// <summary>
    /// Replaces last occurrence of a substring with a substring
    /// </summary>
    class ReplaceLastOccCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "replacelastocc";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_REPLACELASTOCC_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            string processed = text.ReplaceLastOccurrence(toReplace, replaceWith);
