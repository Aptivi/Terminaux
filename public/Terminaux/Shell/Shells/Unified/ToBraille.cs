...
{
    /// <summary>
    /// Converts a string to braille
    /// </summary>
    class ToBrailleCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "tobraille";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_TOBRAILLE_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            string processed = BrailleBuilder.ToBraille(text);
