...
{
    /// <summary>
    /// Contains all of characters in the string
    /// </summary>
    class ContainsAllCharsCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "containsallchars";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_CONTAINSALLCHARS_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = text.ContainsAllOf(sequence.ToCharArray()) ? 0 : 1;
