...
{
    /// <summary>
    /// Ends with all of strings in the string
    /// </summary>
    class EndsWithAllStrsCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "endswithallstrs";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_ENDSWITHALLSTRS_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = text.EndsWithAllOf(sequences) ? 0 : 1;
