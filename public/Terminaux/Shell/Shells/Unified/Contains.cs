...
{
    /// <summary>
    /// Contains a string in the string
    /// </summary>
    class ContainsCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "contains";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_CONTAINS_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = (ignoreCase ? text.ContainsWithNoCase(sequence) : text.Contains(sequence)) ? 0 : 1;
