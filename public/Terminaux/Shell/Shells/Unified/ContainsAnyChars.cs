...
{
    /// <summary>
    /// Contains any of characters in the string
    /// </summary>
    class ContainsAnyCharsCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "containsanychars";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_CONTAINSANYCHARS_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = text.ContainsAnyOf(sequence.ToCharArray()) ? 0 : 1;
