...
{
    /// <summary>
    /// Contains all of strings in the string
    /// </summary>
    class ContainsAllStrsCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "containsallstrs";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_CONTAINSALLSTRS_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = text.ContainsAllOf(sequences) ? 0 : 1;
