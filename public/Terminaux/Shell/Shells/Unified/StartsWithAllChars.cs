...
{
    /// <summary>
    /// Starts with all of characters in the string
    /// </summary>
    class StartsWithAllCharsCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "startswithallchars";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_STARTSWITHALLCHARS_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = text.StartsWithAllOf(sequence.ToCharArray()) ? 0 : 1;
