...
namespace Terminaux.Shell.Shells.Unified
{
    ...
    /// Uppercases a string
    /// </summary>
    class UppercaseCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "uppercase";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_UPPERCASE_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            variableValue = whole ? text.ToUpper() : first ? text.UpperFirst() : text.ToUpper();
            if (print)
