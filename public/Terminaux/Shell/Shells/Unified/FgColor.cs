...
namespace Terminaux.Shell.Shells.Unified
{
    ...
    /// </summary>
    class FgColorCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "fgcolor";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_FGCOLOR_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            {
                TextWriterColor.Write(LanguageTools.GetLocalized("T_SHELL_UNIFIED_FGCOLOR_COLORINVALID"), ThemeColorType.Error);
                return 1;
            }
