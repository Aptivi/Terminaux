...
{
    /// <summary>
    /// Ends with any of strings in the string
    /// </summary>
    class EndsWithAnyStrsCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "endswithanystrs";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_ENDSWITHANYSTRS_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = text.EndsWithAnyOf(sequences) ? 0 : 1;
