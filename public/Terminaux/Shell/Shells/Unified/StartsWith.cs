...
{
    /// <summary>
    /// Starts with a string in the string
    /// </summary>
    class StartsWithCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "startswith";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_STARTSWITH_DESC");
        ...
        public override CommandArgumentInfo[] CommandArgumentInfo =>
            [
                ...
                [
                    ...
                    {
                        ArgumentDescription = LanguageTools.GetLocalized("T_SHELL_UNIFIED_ARGUMENT_SUBSTR_DESC")
                    }),
                ],
                [
                    new SwitchInfo("ignorecase", LanguageTools.GetLocalized("T_SHELL_UNIFIED_SWITCH_IGNORECASE_DESC"), new SwitchOptions()
                    {
                        AcceptsValues = false
                    }),
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = (ignoreCase ? text.StartsWithNoCase(sequence) : text.StartsWith(sequence)) ? 0 : 1;
