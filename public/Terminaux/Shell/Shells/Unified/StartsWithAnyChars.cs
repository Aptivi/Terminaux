...
{
    /// <summary>
    /// Starts with any of characters in the string
    /// </summary>
    class StartsWithAnyCharsCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "startswithanychars";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_STARTSWITHANYCHARS_DESC");
        ...
        public override CommandArgumentInfo[] CommandArgumentInfo =>
            [
                ...
                [
                    ...
                    {
                        ArgumentDescription = LanguageTools.GetLocalized("T_SHELL_UNIFIED_ARGUMENT_CHARSEQ_DESC")
                    }),
                ],
                [
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = text.StartsWithAnyOf(sequence.ToCharArray()) ? 0 : 1;
