...
{
    /// <summary>
    /// Ends with a string in the string
    /// </summary>
    class EndsWithCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "endswith";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_ENDSWITH_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = (ignoreCase ? text.EndsWithNoCase(sequence) : text.EndsWith(sequence)) ? 0 : 1;
