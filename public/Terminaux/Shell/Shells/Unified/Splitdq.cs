...
{
    /// <summary>
    /// Splits a string to a group of strings with double quote support
    /// </summary>
    class SplitdqCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "splitdq";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_SPLITDQ_DESC");
        ...
        public override CommandArgumentInfo[] CommandArgumentInfo =>
            [
                ...
                [
                    ...
                    {
                        ArgumentDescription = LanguageTools.GetLocalized("T_SHELL_UNIFIED_SPLIT_ARGUMENT_DELIMITER_DESC")
                    }),
                ],
                [
        ...
        {
            // Flags
            bool noRelease = parameters.ContainsSwitch("-norelease");
            ...
            string[] processed = noRelease ?
                text.SplitEncloseDoubleQuotesNoRelease(delimiterChar) :
                text.SplitEncloseDoubleQuotes(delimiterChar);
