...
{
    /// <summary>
    /// Starts with all of strings in the string
    /// </summary>
    class StartsWithAllStrsCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "startswithallstrs";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_STARTSWITHALLSTRS_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = text.StartsWithAllOf(sequences) ? 0 : 1;
