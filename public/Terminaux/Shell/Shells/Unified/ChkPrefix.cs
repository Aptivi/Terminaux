...
{
    /// <summary>
    /// Checks prefix in the string
    /// </summary>
    class ChkPrefixCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "chkprefix";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_CHKPREFIX_DESC");
        ...
        public override CommandArgumentInfo[] CommandArgumentInfo =>
            [
                ...
                [
                    ...
                    {
                        ArgumentDescription = LanguageTools.GetLocalized("T_SHELL_UNIFIED_ARGUMENT_PREFIX_DESC")
                    }),
                ],
                [
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = text.VerifyPrefix(prefix) ? 0 : 1;
