...
{
    /// <summary>
    /// Shifts characters a string
    /// </summary>
    class ShiftCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "shift";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_SHIFT_DESC");
        ...
        public override CommandArgumentInfo[] CommandArgumentInfo =>
            [
                ...
                [
                    ...
                    {
                        ArgumentDescription = LanguageTools.GetLocalized("T_SHELL_UNIFIED_SHIFT_ARGUMENT_SHIFT_DESC"),
                        IsNumeric = true,
                    }),
                ],
                [
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            string shiftNumStr = parameters.ArgumentsList[1];
            if (!int.TryParse(shiftNumStr, out var shiftNum))
            {
                TextWriterColor.Write(LanguageTools.GetLocalized("T_SHELL_UNIFIED_SHIFT_SHIFTNUMINVALID"), ThemeColorType.Error);
                return 1;
            }

            // Set the MESH variable to contain the result
            string processed = text.ShiftLetters(shiftNum);
