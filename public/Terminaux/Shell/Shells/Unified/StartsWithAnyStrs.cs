...
{
    /// <summary>
    /// Starts with any of strings in the string
    /// </summary>
    class StartsWithAnyStrsCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "startswithanystrs";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_STARTSWITHANYSTRS_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = text.StartsWithAnyOf(sequences) ? 0 : 1;
