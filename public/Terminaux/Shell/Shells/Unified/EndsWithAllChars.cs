...
{
    /// <summary>
    /// Ends with all of characters in the string
    /// </summary>
    class EndsWithAllCharsCommand : BaseCommand, ICommand
    {
        public override string Command => 
            "endswithallchars";

        public override string HelpDefinition => 
            LanguageTools.GetLocalized("T_SHELL_UNIFIED_ENDSWITHALLCHARS_DESC");
        ...
        public override int Execute(IShell? shell, CommandParameters parameters, ref string variableValue)
        {
            ...
            int errorCode = text.EndsWithAllOf(sequence.ToCharArray()) ? 0 : 1;
