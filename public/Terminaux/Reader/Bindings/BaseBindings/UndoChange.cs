...
{
    internal class UndoChange : BaseBinding, IBinding
    {
        /// <inheritdoc/>
        ...
        public override void DoAction(TermReaderState state)
        {
            ...
            TermReaderTools.InsertNewText(state.changes[state.changes.Count - 1]);
            state.changes.RemoveAt(state.changes.Count - 1);
