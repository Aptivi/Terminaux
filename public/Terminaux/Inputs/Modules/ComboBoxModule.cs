                        ...
                        switch (mouse.Button)
                        {
                            ...
                            case PointerButton.Left:
                                ...
                                if ((arrowSelectUpHitbox.IsPointerWithin(mouse) || arrowSelectDownHitbox.IsPointerWithin(mouse)) && related.Count > selectionReservedHeight)
                                {
                                    ...
                                    bail = InfoBoxTools.UpdateSelectedIndexWithMousePos(mouse, Choices, selectionBoxPosX - 1, selectionBoxPosY, maxSelectionWidth, finalPopoverHeight, out hitboxType, ref currentSelection) && hitboxType == ChoiceHitboxType.Choice;
                                break;
