    ...
    public class FigletSelectorTui : TextualUI
    {
        ...
        private void Select(TextualUI ui, bool write)
        {
            ...
            else
            {
                ...
                selectedFont = InfoBoxSelectionColor.WriteInfoBoxSelection(LanguageTools.GetLocalized("T_INPUT_IS_FIGLET_FONTSELECTPROMPTTITLE"), figletSelections, LanguageTools.GetLocalized("T_INPUT_IS_FIGLET_FONTSELECTPROMPT"));
                font = FigletSelector.fonts[selectedFont];
            }
            selectedFont = FigletSelector.DetermineFigletIndex(font);
            ui.RequireRefresh();
