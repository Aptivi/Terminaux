...
{
    internal class ProtanVienot : BaseTransformationFormula, ITransformationFormula
    {
        public override (int, int, int) Transform(int r, int g, int b, ColorSettings settings)
        {
            ...
            var transformed = Vienot.Transform(r, g, b, TransformationFormula.ProtanVienot, settings.ColorBlindnessSeverity);
            return transformed;
        }
    }
}
