    ...
    public class CieLch : BaseColorModel, IEquatable<CieLch>
    {
        ...
        public static CieLch ParseSpecifier(string specifier)
        {
            ...
            if (specifierArray.Length == 3)
            {
                ...
                throw new TerminauxException($"Invalid CieLch color specifier \"{specifier}\". The specifier may not be more than three elements. Ensure that it's on the correct format: cielch:<C>;<M>;<Y>");
        }
